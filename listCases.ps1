...
$casetypesUrl = "https://lab-16330-us-east-1.internal.pegalabs.io/prweb/api/application/v2/casetypes"
...
$data = Invoke-RestMethod -Uri $casetypesUrl -Headers $headers -Method Get
