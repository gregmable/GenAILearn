...
try {
    $listRes = Invoke-WebRequest -Uri "$($mcpUrl)/tools/list" -Method Post -Headers $headers -Body ($listPayload | ConvertTo-Json -Depth 10) -WebSession $session -UseBasicParsing
